...
buttonIds.forEach((id) => {
  $(`#${id}`).click(() => {
    ...
    if (limited && enaYes && balanceYear) {
        if(safeParseFloat(document.getElementById("two").value) + safeParseFloat(document.getElementById("three").value) <= safeParseFloat(document.getElementById("one").value))
        {
        console.log("Sheet 1");
        hideTabOne();
        hideTabTwo();
        ...
        alert("Total Quantity of rectified spirit should be less than or equal to the quantity of rectified spirit");
      }
    ...
    if (limited && enaNo && balanceYear) {
      if(safeParseFloat(document.getElementById("twelve").value) + safeParseFloat(document.getElementById("thirteen").value) <= safeParseFloat(document.getElementById("eleone").value)) {
        console.log("Sheet 3");
        hideTabOne();
        hideTabTwo();
        showTabThree();
    ...
    if (surplus && enaYes && balanceYear) {
      if(safeParseFloat(document.getElementById("twentyseven").value) + safeParseFloat(document.getElementById("twentyeight").value) <= safeParseFloat(document.getElementById("twentysix").value)) {
        console.log("Sheet 6");
        hideTabOne();
        hideTabTwo();
        showTabThree();
    ...
    if (surplus && enaNo && balanceYear) {
      if(safeParseFloat(document.getElementById("thirtytwo").value) + safeParseFloat(document.getElementById("thirtythree").value) <= safeParseFloat(document.getElementById("thirtyone").value)) {
        console.log("Sheet 7");
      hideTabOne();
      hideTabTwo();
      showTabThree();
...
function setValues() {
  ...
  let value6 = safeParseFloat(document.getElementById("seven").value);
  let value7 = safeParseFloat(document.getElementById("seven2").value);
  let value8 = safeParseFloat(document.getElementById("nine").value);
  let value9 = value6 * value8;
  let value10 = value7 * value8;
  document.getElementById("fourtysix").value = value5;
  document.getElementById("fourtysix2").value = value3;
  document.getElementById("fourtyeight").value = value9;
  document.getElementById("fourtyeight2").value = value10;
  formatNumber("fourtysix");
  formatNumber("fourtyeight");
...
function setValues2() {
  ...
  // let value6 = safeParseFloat(document.getElementById("eighteen2").value);
  // let value7 = safeParseFloat(document.getElementById("eighteen").value);
  // let value8 = safeParseFloat(document.getElementById("twenty").value);
  // let value9 = value6 * value8;
  // let value10 = value7 * value8;

  document.getElementById("fiftyfour").value = value5;
  document.getElementById("fiftyfour2").value = value3;
  // document.getElementById("fiftyfour").value = value10;
  // document.getElementById("fiftyfour2").value = value9;
...
function setValues3() {
  ...
  let value3 = value1 * value2;
  let value5 = value4 * value2;
  let value6 = safeParseFloat(document.getElementById("twentytwo").value);
  let value7 = safeParseFloat(document.getElementById("twentytwo2").value);
  let value8 = safeParseFloat(document.getElementById("twentyfour").value);
  let value9 = value6 * value8;
  let value10 = value7 * value8;
  document.getElementById("fiftyeight").value = value5;
  document.getElementById("fiftyeight2").value = value3;
  document.getElementById("sixty").value = value9;
  document.getElementById("sixty2").value = value10;
...
function setValues5() {
  let value1 = safeParseFloat(document.getElementById("three").value);
  let value4 = safeParseFloat(document.getElementById("five").value);
  let value5 = safeParseFloat(document.getElementById("two").value);
  let value6 = safeParseFloat(document.getElementById("four").value);
  let value3 = value1 * value4;
  let value7 = value5 * value6;
  document.getElementById("fourtytwo").value = value3;
  document.getElementById("fourtyfour").value = value7;
  formatNumber("fourtytwo");
  formatNumber("fourtyfour");


}
function setValues6() {
  let value1 = safeParseFloat(document.getElementById("thirteen").value);
  let value4 = safeParseFloat(document.getElementById("fifteen").value);
  let value3 = value1 * value4;
  let value5 = safeParseFloat(document.getElementById("twelve").value);
  let value6 = safeParseFloat(document.getElementById("fourteen").value);
  let value7 = value5 * value6;
  document.getElementById("fifty").value = value3;
  document.getElementById("fiftytwo").value = value7;
  formatNumber("fifty");
  formatNumber("fiftytwo");
}
function setValues7() {
  let value1 = safeParseFloat(document.getElementById("twentyeight").value);
  let value4 = safeParseFloat(document.getElementById("thirty").value);
  let value3 = value1 * value4;

  let value5 = safeParseFloat(document.getElementById("twentyseven").value);
  let value6 = safeParseFloat(document.getElementById("twentynine").value);
  let value7 = value5 * value6;
  document.getElementById("sixtytwo").value = value3;
  document.getElementById("sixtyfour").value = value7;
  formatNumber("sixtytwo");
  formatNumber("sixtyfour");

}
function setValues8() {
  let value1 = safeParseFloat(document.getElementById("thirtythree").value);
  let value4 = safeParseFloat(document.getElementById("thirtyfive").value);
  let value3 = value1 * value4;

  let value5 = safeParseFloat(document.getElementById("thirtytwo").value);
  let value6 = safeParseFloat(document.getElementById("thirtyfour").value);
  let value7 = value5 * value6;

  document.getElementById("sixtyeight").value = value7;
  document.getElementById("sixtysix").value = value3;

  formatNumber("sixtysix");
...
function formatNumberPDF2(valuePDF) {
  // Remove non-numeric characters
  valuePDF = valuePDF.toString().replace(/\D/g, "");
  
  // Convert to number and shift decimal place
  let num = parseFloat(valuePDF) / 100000;
...
async function updatePDFAndDownload2(
  ...
  firstPage.drawText((value10).toString(), {
    x: 430,
    y: 260,
    size: 12,
    color: PDFLib.rgb(0, 0, 0),
  });
  firstPage.drawText((value11).toString(), {
    x: 610,
    y: 260,
    size: 12,
    color: PDFLib.rgb(0, 0, 0),
